...
<title>${SITE_CMS_SITE_NAME}-修改学校</title>
</head>
...
<div id="container" class="fn-clear">
    ...
    <div id="content">
        <p class="crumbs">当前位置：基础数据&nbsp;&gt;&nbsp;<a href="${DOMAIN_CMS}/basic/schoolManage.htm">学校维护</a>&nbsp;&gt;&nbsp;<span>修改学校信息</span></p>
        <ul class="public-tab fn-clear mt-10">
            <span class="tt" title="${school.schoolName!}"><@cutOff cutStr="${school.schoolName!}" cutLen="20"/></span>
            <li class="current" onclick="javascript:window.location.href='${DOMAIN_CMS}/basic/schoolEdit.htm?schoolId=${schoolId!}'">基本信息</li>
        </ul>
        <form id="schoolForm" method="post" action="${DOMAIN_CMS}/basic/schoolEdit.htm">
        ...
        <table class="form-table validateForm mt-10">
            ...
            <tr>
                <th>联系电话：</th>
                <td><input type="text" class="input-txt" id="contactPhoneInput" name="school.contactPhone" regex="/^([0-9])\d{6,10}$/" regexMsg="请输入正确的联系电话" maxlength="20" value="${school.contactPhone!}"></td>
            </tr>
            <tr>
                <th>Email：</th>
...
<@footer />
<#include "/pages/jsinclude/basic/school/editSchoolJs.ftl" />
<script>
$(function(){
    EditSchool.init();
});
