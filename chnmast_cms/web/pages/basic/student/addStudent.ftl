        ...
        <input type="password" style="display:none"><!-- 解决火狐和谷歌浏览器自动填充用户名和密码问题 -->
            <div class="userInfo-wrap">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" class="input-txt" id="phoneInput" name="student.phone" notNull="true" maxlength="25" placeholder="输入手机号码" value="${student.phone!}"/>
                    </td>
                </tr>
                   <tr>
                    <th>性别：</th>
                ...
                <tr>
                    ...
                    <td>
                        <input class="input-txt"  id="passwordInput" name="student.password" type="password" notNull="true" maxlength="20" oncopy="return false;" oncut="return false;" onpaste="return false" onkeyup="return showPwdRank(this.value);return false;">
                    </td>
                </tr>
...
<#include "/pages/jsinclude/basic/student/addStudentJs.ftl" />
<script>
    $(function(){
        AddStudent.init();
    });
