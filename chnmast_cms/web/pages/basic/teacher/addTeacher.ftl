...
<title>${SITE_CMS_SITE_NAME}-新增名师大家</title>
</head>
...
<div id="container" class="fn-clear">
    ...
    <div id="content">
        <p class="crumbs">当前位置：基础数据&nbsp;&gt;&nbsp;<a href="${DOMAIN_CMS}/basic/teacherManage.htm">名师大家</a>&nbsp;&gt;&nbsp;<span>新增名师大家</span></p>
        <form id="teacherForm" method="post" action="${DOMAIN_CMS}/basic/addTeacher.htm">
        ...
        <div class="userInfo-wrap">
            <table class="form-table validateForm mt-10">
                    ...
                    <td>
                        <select class="input-sel w-200" name="teacherTypeValue" notNull="true">
                            ...
                            <#list teachTypes as type>
                                <option value="${type.value}" <#if teacherTypeValue?default(0) == type.value>selected</#if>>${type.nameValue!}</option>
                            </#list>
                        </select>
                    </td>
                </tr>
                ...
                <tr>
                    <th>简介：</th>
                    <td><textarea class="text-area fn-left t-350" id="introductionInput" name="teacher.introduction" >${teacher.introduction!}</textarea></td>
                </tr>
                <tr>
                    <th><span class="must">*</span>用户名：</th>
                    <td>
                        <input type="text" class="input-txt" id="usernameInput" name="teacher.username" regex="/^[a-zA-Z0-9_]+$/" regexMsg="请输入英文字母或是数字,其它字符是不允许的" notNull="true" maxlength="25" placeholder="输入用户名" value="${teacher.username!}"/>
                    </td>
                </tr>
                <tr>
                    <th><span class="must">*</span>密码：</th>
                    <td>
                        <input class="input-txt"  id="passwordInput" name="teacher.password" type="password" notNull="true" maxlength="20" oncopy="return false;" oncut="return false;" onpaste="return false" onkeyup="return showPwdRank(this.value);return false;">
                    </td>
                </tr>
...
<@footer />
<#include "/pages/jsinclude/basic/teacher/addTeacherJs.ftl" />
<script>
$(function(){
    AddTeacher.init();
});
