...
<title>${SITE_CMS_SITE_NAME}-新增培训基地</title>
</head>
...
<div id="container" class="fn-clear">
    ...
    <div id="content">
        <p class="crumbs">当前位置：基础数据&nbsp;&gt;&nbsp;<a href="${DOMAIN_CMS}/basic/agencyManage.htm">培训基地</a>&nbsp;&gt;&nbsp;<span>新增培训基地</span></p>
        <form id="agencyForm" method="post" action="${DOMAIN_CMS}/basic/addAgency.htm" target="addAgencyFrame">
        ...
        <table class="form-table validateForm mt-10">
                ...
                <td>
                    <select class="input-sel w-200" name="agencyTypeValue" notNull="true">
                        ...
                        <#list agencyTypes as type>
                            <option value="${type.value}" <#if agencyTypeValue?default(0) == type.value>selected</#if>>${type.nameValue!}</option>
                        </#list>
                    </select>
                </td>
            </tr>
            ...
            <tr>
                <th>联系电话：</th>
                <td><input type="text" class="input-txt" id="contactPhoneInput" name="agency.contactPhone" regex="/^([0-9])\d{6,11}$/" regexMsg="请输入正确的联系电话" maxlength="20" value="${agency.contactPhone!}"></td>
            </tr>
            <tr>
                <th>Email：</th>
            ...
            <tr>
                ...
                <td><textarea class="text-area fn-left t-350" id="introductionInput" notNull="true" name="agency.introduction" maxlength="4000">${agency.introduction!}</textarea></td>
            </tr>
            <tr>
                <th><span class="must">*</span>基地管理员：</th>
                <td>
                    <input type="text" class="input-txt" id="usernameInput" name="agency.username" regex="/^[a-zA-Z0-9_]+$/" regexMsg="请输入英文字母或是数字,其它字符是不允许的" notNull="true" maxlength="25" placeholder="输入管理员用户名" value="${agency.username!}"/>
                </td>
            </tr>
            <tr>
                <th><span class="must">*</span>密码：</th>
                <td>
                    <input class="input-txt"  id="passwordInput" name="agency.password" type="password" notNull="true" maxlength="20" oncopy="return false;" oncut="return false;" onpaste="return false" onkeyup="return showPwdRank(this.value);return false;">
                </td>
            </tr>
            <tr id="levelTr">
                <th>&nbsp;</th>
            ...
            <tr>
                ...
                <td><input class="input-txt" id="repassword" type="password" notNull="true" maxlength="20"></td>
            </tr>
            <tr>
                <th>&nbsp;</th>
        ...
        <iframe id="addAgencyFrame" name="addAgencyFrame" style="display: none;"></iframe>
    </div>
</div>
<@footer />
<#include "/pages/jsinclude/basic/agency/addAgencyJs.ftl" />
<script>
$(function(){
    AddAgency.init();
});
function showResult(msg, isSuccess, id){
    AddAgency.showResult(msg, isSuccess, id);
}
</script>
</body>
</html>