        ...
        <ul class="public-tab fn-clear mt-10">
            ...
            <div class="fn-clear">
                    ...
                    <table class="form-table validateForm mt-10">
                        ...
                        <tr>
                            <th style="width:140px;">主讲：</th>
                            <td >${(comment.speakerName)!''}</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                 <#if comment.auditStatus == 'AUDITPASS'><#-- 审核中 -->
                                     <a href="javascript:;" id="audit2" class="abtn abtn-blue" dataValue="${comment.id!}" flag="1">审核不通过</a>
                                 <#elseif comment.auditStatus == 'AUDITPASS' || comment.auditStatus == 'AUDITNOPASS'>
                                     <a href="javascript:;" id="audit1" class="abtn abtn-blue" dataValue="${comment.id!}" flag="1">审核通过</a>
                                     <#--   
                                     <a href="javascript:;" id="audit3" class="abtn abtn-blue" dataValue="${comment.id!}" flag="1">取消审核</a>
                                     -->
                                 </#if>
                                 <a href="${DOMAIN_CMS}/audit/comment/commentAuditManage.htm" id="back" class="abtn abtn-green">返回</a>
                            </td>
                        </tr>
                    </table>
                </div>
