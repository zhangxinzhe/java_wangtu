    ...
    <div id="content">
        ...
        <table class="form-table validateForm mt-10">
            <tr>
                <th>视频标题：</th>
                     <td> 
                        <input type="text" class="input-txt" id="videoName" name="videoName" value="${videoName!}" />
                     </td>
                </tr>
            <tr>
                <th>评论时间：</th>
        ...
        <div class="record-wrap mt-10">
            ...
            <table class="public-table">
                <tr>
                    <th width="10%" class="t-center"></th>
                    <th  width="10%">视频标题</th>
                    <th class="t-center" width="10%">评论人</th>
                    <th width="30%">评论内容</th>
                    <#--
                    <th class="t-center">评论人IP</th>
                    -->
                    <th width="10%" class="t-center">审核状态</th>
                ...
                <tr>
                    ...
                    <td class="t-center">
                        <a href="${DOMAIN_CMS}/audit/comment/videoComment.htm?id=${(item.id)!'0'}" title="查看">查看审核</a>
                    </td>
                </tr>
                </#list>
                </#if>
