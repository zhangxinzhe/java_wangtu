...
<div id="container" class="fn-clear">
    ...
    <div id="content">
        ...
        <ul class="public-tab fn-clear mt-10">
            <li flag="1" class="current">充值记录</li>
            <li flag="2">购买记录</li>
            <li flag="3">个人账户</li>
        </ul>
        <form id="iospayStatForm" action="${DOMAIN_CMS}/stat/iospayStat.htm" method="post">
        ...
        <div class="record-wrap mt-10">
            <div class="filter">
                <span class="fn-txt pl-50 c-red f18">合计</span>
                <span class="fn-txt pl-30 c-red f16">交易金额：${totalAmount!}元</span>
                <span class="fn-txt pl-50 c-red f16">实收金额：${actualAmount!}元</span>
            </div>
            <@doublePage2>
            <table class="public-table">
                ...
                <tr>
                    ...
                    <td>${record.changeFunds?string("0.00")}</td>
                    <td>${(record.changeFunds*0.70)?string("0.00")}</td>
