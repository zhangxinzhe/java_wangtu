...
<div id="container" class="fn-clear">
    ...
    <div id="content">
        <p class="crumbs">当前位置：首页管理 > <a href="${DOMAIN_CMS}/homepage/college/collegeManage.htm">高校风采展示</a> > <span>新增</span></p>
        ...
        <div class="userImg-wrap fn-right mr-20">
            ...
            <p class="img" style="width:154px;height:154px"><img id="picImg" src="${DOMAIN_UPLOAD_FILE}/images/college_logo.png" alt="高校logo图片" style="margin:0 35px;"></p>
            <p class="t-center">
        ...
        <table class="form-table validateForm mt-10">
            ...
            <tr>
                ...
                <div class="userImg-wrap fn-left" style="width:500px">
                    ...
                    <p class="img" style="width:500px;height:60px"><img id="picImg2" src="${DOMAIN_UPLOAD_FILE}/images/college_bg.jpg" alt="高校风采图片" ></p>
                    <p class="t-center">
...
<@footer />
<#include "/pages/jsinclude/homepage/collegeAddjs.ftl" />

<script>
$(function(){
    window.CollegeAdd.init();
});
