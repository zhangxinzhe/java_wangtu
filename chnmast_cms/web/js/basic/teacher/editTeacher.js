(function($, window, document){
    ...
    //保存
    function addTeacher(){
    	FieldMsg.clearFieldError("#teacherForm"); //清除各字段的报错提示
    	//整个表单所有数据验证   错误信息
       	if(!Verify.checkAllVerify("#teacherForm")) return;
       	if(!Verify.checkOverLen3("#usernameInput","用户名", 4,20))return;
