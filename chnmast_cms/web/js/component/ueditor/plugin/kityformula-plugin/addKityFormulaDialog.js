UE.registerUI('kityformula', function(editor, uiname){
    ...
    var kfDialog = new UE.ui.Dialog({
        ...
        // 指定弹出层路径
        iframeUrl: editor.options.UEDITOR_HOME_URL + 'plugin/kityformula-plugin/kityFormulaDialog.html',
        // 编辑器实例
        editor: editor,
        // dialog 名称
        name: uiname,
    ...
    var iconUrl = editor.options.UEDITOR_HOME_URL + 'plugin/kityformula-plugin/kf-icon.png';
