...
function ByteLength(str) 
{
    ...
    {
        if(str.charCodeAt(i)<0 || str.charCodeAt(i)>255){byteLen++;}
    }    
    return byteLen;
}
...
{    
    ...
    IsSpansEnoughCharacterSets(IsSideStrongPassword.arguments[0], "4") );
...
function IsMediumPassword()
{
   ...
   ( IsSpansEnoughCharacterSets(IsMediumPassword.arguments[0], "2")||IsSpansEnoughCharacterSets(IsMediumPassword.arguments[0], "3")) &&
...
function printIntensity(rank) {
	...
	var obj2;
	if (rank == 1 || rank == 0) {
		obj =document.getElementById("weak");
		// 清 中和强的class
		obj1=document.getElementById("middle");
		obj2 =document.getElementById("strong");
		obj1.className = "";
		obj2.className = "";
	} else if (rank == 2) {
		obj =document.getElementById("middle");
		// 清 弱和强的class
		obj1=document.getElementById("weak");
		obj2 =document.getElementById("strong");
		obj1.className = "";
		obj2.className = "";
	} else if (rank == 3) {
		obj =document.getElementById("strong");
		// 清 弱和中的class
		obj1=document.getElementById("weak");
		obj2 =document.getElementById("middle");
		obj1.className = "";
		obj2.className = "";
	}
...
function printRank(rank,str) {
  var  obj =document.getElementById("securityLevel");
  if(obj==null){
	  return;
  }
  if(str){
	if (rank == 1 || rank == 0) {// 弱的class
	  obj.className = "acc-safety acc-safety-low";
	} else if (rank  == 2) {// 中的class
	  obj.className = "acc-safety acc-safety-middle";
	} else if (rank >= 3) {// 强的class
	  obj.className = "acc-safety acc-safety-high";
    }
	$("#levelTr").show();
  } else {
    $("#levelTr").hide();
